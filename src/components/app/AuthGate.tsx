  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-black px-4">
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle at 50% 18%, rgba(212,168,75,0.22), transparent 58%)" }}
      />
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        <div className="mx-auto mb-6 flex size-16 items-center justify-center">
          <motion.span className="absolute size-16 rounded-full border border-[#d4a84b]/30 border-t-[#d4a84b]" animate={{ rotate: 360 }} transition={{ duration: 8, repeat: Infinity, ease: "linear" }} />
          <BrandHexLogo size={34} />
        </div>
        ...
        <button
          ...
          disabled={busy}
          onClick={onDiscord}
          className="relative mt-8 inline-flex w-full items-center justify-center overflow-hidden rounded-full border border-[#d4a84b]/40 bg-[#d4a84b] px-6 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-black disabled:opacity-60"
        >
