          ...
          {pin ? (
            <>
              ...
              <div className="rounded-xl border border-[#d4a84b]/40 bg-[#d4a84b]/10 p-4">
                <div className="font-display text-2xl text-[#e8c56a]">{pin.name}</div>
                ...
                <div className="mt-3 flex gap-2">
                  <button type="button" onClick={() => claimMut.mutate()} className="rounded-full bg-[#d4a84b] px-5 py-2 text-sm font-semibold text-black">Yes · lock {radarRange}</button>
